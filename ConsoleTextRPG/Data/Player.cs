...
=======
        ...
        public Player(string name)
        {
            ...
            this.Name = name;
            // 플레이어의 초기 기본 능력치를 설정합니다. (레벨 1, 공격력 10, 방어력 5, 체력 100, 마나50, 민첩 5)
            this.Stat = new CharacterStat(1, 10, 5, 100, 50, 5);
        ...
        public void SetJob(string job)
        {
            ...
            this.Job = job;
            if (job == "Warrior" || job == "전사")
            {
                // 레벨, 공격력, 방어력, 최대체력, 마나, 민첩
                Stat.SetBaseStats(1, 15, 10, 120, 30, 20);
                this.Job = "Warrior"; // 통일
            }
            else if (job == "Mage" || job == "마법사")
            {
                Stat.SetBaseStats(1, 20, 5, 80, 100, 10);
                this.Job = "Mage";  // 통일
            }
        }
        ...
        public void LoadFromData(SaveData data)
        {
            ...
            this.Gold = data.Gold;
            this.Stat.SetBaseStats(data.Level, data.BaseAttack, data.BaseDefense, data.MaxHp, data.MaxMp, data.Dexterity);
